    ...
    return (
      <Menu size="huge" fluid>
        ...
        <Menu.Item href="https://drive.google.com/open?id=1qxgsbqucXccKLcHIOhPdimjkNTSEUAku"
            name='Resume' target="_blank" rel="noopener noreferrer"
            active={activeItem === 'Resume'} onClick={this.handleItemClick}>
          Resume
        </Menu.Item>
        
        <Menu.Item href="/experience" name='Experience' active={activeItem === 'Experience'} onClick={this.handleItemClick}>
          Experience
        </Menu.Item>
