        ...
        return (
            ...
            <div className="padded-grid">
                ...
                <Item.Group divided relaxed>
                    <Item>
                        <Item.Image src={twister} size="medium"/>
                        <Item.Content>
                            ...
                            <Item.Description className="left-align">
                                <List>
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                                Part of CS 307 - Software Engineering. A semester long scrum focused team project. We were given some guidelines to follow and a base product to build - a twitter clone
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                            Responsible for the front end of the project. Used React Bootstrap JS with CSS
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                </List>
                            ...
                            <Item.Extra>
                                <Grid columns={3} container>
                                    <Grid.Row>
                                        ...
                                        <Grid.Column>
                                            <a href="https://purdue0-my.sharepoint.com/:w:/g/personal/fallon2_purdue_edu/Ef8pPpCgvgdHtUEkNpjTthoBoC4DdwrRmAsgIFiRxx1_Zg?e=WZVWvd" target="_blank" rel="noopener noreferrer">
                            ...
                            <Item.Description className="left-align">
                                <List>
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                            Partnered with T-Mobile as part of a customer hack to build a self-driving car
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                            Responsible for testing the collisions and tuning hyperparameters
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                </List>
                    ...
                    <Item>
                        ...
                        <Item.Content>
                            ...
                            <Item.Meta>Qualcomm Hackmobile</Item.Meta>
                            <Item.Description className="left-align">
                                <List>
                                    <List.Item>
                                        <Icon name="gg circle" />   
                                    ...
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                            Responsible for the hardware configuration with the Arduino and the servo motor
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                </List>
                            ...
                            <Item.Extra>
                                <Grid columns={4} container>
                                    <Grid.Row>
                                        ...
                                        <Grid.Column>
                                            <a href="https://github.com/baranusluel/autoknoby/blob/master/autoknoby.pdf" target="_blank" rel="noopener noreferrer">
                                                <Icon name="book" size="big"/>    
                                            </a>
                                            <p>Project Description</p>
                                        </Grid.Column>
                    ...
                    <Item>
                        <Item.Image src={go_out} size="medium"/>
                        <Item.Content>
                            ...
                            <Item.Description className="left-align">
                                <List>
                                    <List.Item>
                                        ...
                                        <List.Content>
                                            <List.Description>
                                            Part of CS 252 - Systems Programming class. Was given creative freedom to work on anything. Used this opportunity to get familiar with client-server architecture with Python Flask/HTML/JS
                                            </List.Description>
                                        </List.Content> 
                                    </List.Item>
                                    <List.Item>
                            ...
                            <Item.Extra>
                                <Grid columns={3} container>
                                    <Grid.Row>
                                        ...
                                        <Grid.Column>
                                            <a href="https://drive.google.com/open?id=1DNk1ISoPzshbW1uUACPwovDJe5nnybeSD9z1JiST27w" target="_blank" rel="noopener noreferrer">
                                                <Icon name="book" size="big"/>    
                                            </a>
                                            <p>Project Description</p>
                                        </Grid.Column>
